...
difficulty: beginner
keyTakeaways:
  - Demonstrates all available MDX components in the blog system
...
prerequisites: None
targetAudience: Content authors and developers working with the blog system
`}
/>
...
The `<LLMOnly>` component contains metadata visible only to LLM crawlers, not users. It **must** appear immediately after frontmatter in every blog post.
...
<EmbedBlog slug="production-ready-rag-guide" />
