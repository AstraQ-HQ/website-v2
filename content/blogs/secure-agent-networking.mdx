...
summary: "Preventing SSRF and lateral movement by dynamically provisioning Kubernetes Network Policies for untrusted workloads."
...
In <EmbedResource resourceType="blog" slug="secure-microvm-runtime" />, we solved the _compute_ isolation problem by wrapping untrusted agents in Firecracker MicroVMs.
