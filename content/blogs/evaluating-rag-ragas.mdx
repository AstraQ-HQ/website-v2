...
In our <EmbedBlog slug="rag-complete-guide" placeholder="RAG Complete Guide" /> and <EmbedBlog slug="advanced-rag-agents" placeholder="Advanced RAG Agents" /> articles, we built production-ready retrieval systems with hybrid search and multi-hop reasoning. But how do you know if your RAG system is actually *good*? Enter **RAGAS**, the gold standard for evaluating retrieval-augmented generation systems.
...
## The Complete RAG Series

<Callout variant="success" title="Master RAG Development" icon="book-open">
  This is Part 3 of our comprehensive RAG series:

  1. <EmbedBlog slug="rag-complete-guide" /> - Fundamentals with Qdrant & FastEmbed
  2. <EmbedBlog slug="advanced-rag-agents" /> - Agentic RAG with chain-of-thought reasoning
  3. **Evaluating RAG with RAGAS** - You are here ✓
</Callout>

*Need help evaluating your RAG system? [Contact us](/contact) to learn how AstraQ can help you build reliable AI applications.*
