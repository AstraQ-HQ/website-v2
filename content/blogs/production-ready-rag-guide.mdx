...
<Callout variant="success" title="Advanced Guide" icon="arrow-right">
  <EmbedBlog slug="multi-hop-rag-agents" /> - Learn how to build agentic RAG
  systems that can perform multi-hop reasoning, query restructuring, and use
  retrieval as a tool with LangChain.
</Callout>
