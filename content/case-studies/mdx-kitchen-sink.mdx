...
summary: "A comprehensive test page showcasing every MDX component and feature available in the case study system."
...
threatActors:
  - "Test Actor"
impact: "This is a test case study for demonstrating MDX components and features."
relatedCVEs:
  - "CVE-2024-0001"
  - "CVE-2024-0002"
lessonsLearned:
  - "MDX components render correctly in case studies"
  - "All formatting options work as expected"
  - "Case study-specific metadata displays properly"
tags:
  - "test"
  - "reference"
  - "mdx"
...
difficulty: beginner
keyTakeaways:
  - Demonstrates all available MDX components in the case study system
  - Serves as a visual reference for component rendering
  - Contains examples of typography, code blocks, diagrams, and custom components
prerequisites: None
targetAudience: Content authors and developers working with the case study system
`}
/>

This case study demonstrates every MDX component and feature available. Use it as a reference and to verify all components render correctly.

## LLMOnly Component

The `<LLMOnly>` component contains metadata visible only to LLM crawlers, not users. It **must** appear immediately after frontmatter in every case study.
...
This is a regular paragraph with **bold text**, _italic text_, and **_bold italic text_**. You can also use ~~strikethrough~~ text.
...
<Accordion type="single" collapsible>
  <AccordionItem value="item-1">
    ...
    <AccordionContent>
      ...
      documents. You can import components and use them alongside your content.
    </AccordionContent>
  </AccordionItem>
  <AccordionItem value="item-2">
    <AccordionTrigger>How does syntax highlighting work?</AccordionTrigger>
    <AccordionContent>
      Syntax highlighting is powered by Shiki, which uses TextMate grammars for
      accurate tokenization. It supports many programming languages out of the
      box.
    </AccordionContent>
  </AccordionItem>
  <AccordionItem value="item-3">
    ...
    <AccordionContent>
      Yes! You can create custom React components and use them directly in your
      MDX files. This allows for interactive and dynamic content.
    </AccordionContent>
  </AccordionItem>
</Accordion>
...
Images can be conditionally displayed based on the color scheme using URL hash fragments:

![Dark Mode Image](https://placehold.co/800x400/1a1a1a/ffffff?text=Dark+Mode+Image#dark-mode-only)

![Light Mode Image](https://placehold.co/800x400/ffffff/1a1a1a?text=Light+Mode+Image#light-mode-only)

The `#dark-mode-only` hash will hide the image in light mode and show it in dark mode. The `#light-mode-only` hash does the opposite.
...
<EmbedResource resourceType="blog" slug="production-ready-rag-guide" />

<EmbedResource resourceType="case-study" slug="mdx-kitchen-sink" />

Note: The EmbedResource component can be used in case studies to reference related blog posts or case studies.
...
This kitchen sink demonstrates all available MDX components for case studies. If you can see this page rendered correctly, all components are working! :tada:

This test case study includes:
- All standard MDX components and formatting
- Case study-specific metadata (severity, attack types, etc.)
- Examples of how to structure case study content
